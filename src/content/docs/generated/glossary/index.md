---
title: "Glossary"
description: "Glossary entries for the unofficial FROGGY HATES SNOW wiki."
draft: false
---
...
| Name | Status | Summary |
|---|---|---|
| [Anomalous zone challenges](anomalous-zone-challenges/) | Verified | Steam devlog examples include timed survival, hidden-object digging, vanishing-item collection, passcode fragments, totems, stone buttons, timed rolls, and throwable-object interactions. |
...
| [Survival loop](survival-loop/) | Verified | Run structure: leave home, dig, fight, collect, return resources, and grow stronger. |
| [UI Scale](ui-scale/) | Verified | Post-launch update says the default UI scale and Steam Deck UI scale were increased. |
| [Warmth](warmth/) | Verified | Survival resource concept; Steam copy says warmth means survival. |
