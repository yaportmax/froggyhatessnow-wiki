---
title: "Steam Source Snapshot"
description: "Current public Steam metadata snapshot for FROGGY HATES SNOW."
draft: false
---
...
Accessed: **2026-05-13**. Generated: 2026-05-13T11:27:40.891Z.
...
|---|---|---|
| App ID | 3232380 | 4037600 |
| Title | FROGGY HATES SNOW | FROGGY HATES SNOW Demo |
| Type | game | demo |
| Release | {"coming_soon":false,"date":"May 7, 2026"} | {"coming_soon":false,"date":"Sep 24, 2025"} |
| Developer | CRYING BRICK | CRYING BRICK |
| Publisher | Digital Bandidos | Digital Bandidos |
| Platforms | {"windows":true,"mac":false,"linux":false} | {"windows":true,"mac":false,"linux":false} |
...
Steam appdetails currently lists 14 full-game screenshots. The thumbnails below are public Steam CDN URLs and link to the public full-size Steam images.
...
| 2026-05-07 | `steam-launch-news` | [Froggy Hates Snow is out now!](https://steamstore-a.akamaihd.net/news/externalpost/steam_community_announcements/1832065502812843) | Launch announcement for the released full game. |
| 2026-05-04 | `steam-launch-devlog` | [Devlog #7: What's New For Launch?](https://steamstore-a.akamaihd.net/news/externalpost/steam_community_announcements/1831432155577514) | Launch devlog naming movement skills, projectile skills, robotic helpers, status effects, and skill-management systems. |
...
| Steam demo/devlog posts describe quest-based meta-progression and Blue Gems as unlock resources for characters, abilities, and locations. | `steam-demo-overhaul-news`, `steam-next-demo-devlog`, `steam-anomalous-zones-devlog` | high | `items`, `guides`, `glossary` | Exact quest names, Blue Gem costs, and unlock order still need verification. |
