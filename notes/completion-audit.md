...
- `npm run domain:status`: read-only check reports `domain_available_not_registered`, DNS retrieve returns `INVALID_DOMAIN`, and the helper prints the exact post-verification registration command; check request id `019e2170-3bb2-7845-8902-e826264902f4`, DNS retrieve request id `019e2170-3eb3-7b4a-83ce-28e91a4b4a06`.
