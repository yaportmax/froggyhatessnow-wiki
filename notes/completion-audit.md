...
| Domain research | `notes/domain-options.md` lists all required candidates, registrar, registration/renewal prices, pros/cons, best recommendation, backups, sources, and attempt history. `notes/porkbun-verification-support.md` contains the current support-ready blocker packet. | Done |
